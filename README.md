# Bus-Tracker
Create a live map of the bus routes between Mit and Harvard campus. Created a function and gathered data to move the buses between different locations on the map. 
